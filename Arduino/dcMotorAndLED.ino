...
//
//int motorPin = 2;      // LED connected to digital pin 9
//int val = 50;         // variable to store the read value
//int Rot_1 = 3;
//int Rot_2 = 4;
...
void Motor_Drive_right(){
  digitalWrite(Rot_1,0);
  digitalWrite(Rot_2,1);
  analogWrite(motorPin, 200);
  delay(200);
  analogWrite(motorPin, 100);
  delay(2000);
}
void Motor_Drive_left(long start_time){
  long now = millis();
  digitalWrite(Rot_1,1);
  digitalWrite(Rot_2,0);
...
void Motor_Drive_right(long start_time){
  long now = millis();
  digitalWrite(Rot_1,0);
  digitalWrite(Rot_2,1);
  if (now - start_time < 200) {
